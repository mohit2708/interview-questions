...
<html lang="en">
   ...
   <body>
      <div class="container">
         <h3>Ques. What is the PHP?</h3>
         <p>Ans:-</p>
         <ul>
            <li>PHP is an open source server side scripting language used to develop dynamic websites . PHP stands for Hypertext Preprocessor , also stood for Personal Home Page. It was created by Rasmus lerdorf in 1995 . It is free software released under the PHP license .</li>
            <li>PHP is an acronym for "PHP: Hypertext Pre-processor" And Old name of PHP personal home page.</li>
            <li><strong><em>Rasmus Lerdorf</em></strong> is known as the father of PHP. 1994</li>
            <li>PHP is a server side scripting language/s/w/tool commonly used for web applications. And PHP has many framework and CMS for creating a website.</li>
            <li>PHP is a widely-used, open source scripting language. And server side scripting language.</li>
            <li>PHP it is used to manage dynamic content, databases, session tracking, even build entire e-commerce sites.</li>
         </ul>
         <h3>Ques. Which is the latest version of PHP?</h3>
			<p><strong>Ans.</strong> The latest stable version of PHP is 7.2 released on November 30, 2019.</p>
		<h3>Ques. What Type of Framework in Php?</h3>
			<p><strong>Ans.</strong> Cakephp, Laravel, Codeigniter, Yii 2, Zend Framework, Phalcon, Slim, FuelPhp, Phpixie, etc</p>
